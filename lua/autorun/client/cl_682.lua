...
surface.CreateFont("MainFontLarge",LargeMainFontData)
...
hook.Add("HUDPaint", "draw-682-hud", function()
    ...
    if Client:HasWeapon("scp682") then
        ...
        draw.SimpleTextOutlined(tostring(math.floor(Client:GetNWFloat("682Bodymass")*100)).."%", "MainFontLarge", Width/2, 90, Color( 255, 100, 100, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 2, Color(0,0,0,255))
    end
end)